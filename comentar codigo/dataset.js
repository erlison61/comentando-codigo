...
const dataset = [
  ...
  //export: é usado quando criamos módulos para exportar ligações em tempo real através de declarações import
  //default: uso recomendado para evitar duplicação por importação js
